export default function SummaryPanel({ expenses }) {
  ...
  return (
    <div className="grid md:grid-cols-3 gap-4 mb-6">
      ...
      {/* Highest Expense */}
      <div className="bg-white rounded-lg shadow p-4">
        <h2 className="text-gray-500 text-sm">Highest Expense</h2>

        <p className="text-3xl font-bold mt-2">₹{highestExpense}</p>
      </div>

      {/* Category Totals */}
      <div className="bg-white rounded-lg shadow p-4">
        <h2 className="text-gray-500 text-sm mb-2">Category Totals</h2>
